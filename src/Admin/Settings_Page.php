...
namespace PhoenixWP\BridgeGermanMarketWcml\Admin;

use PhoenixWP\BridgeGermanMarketWcml\Install;
...
final class Settings_Page {
	...
	public function register_menu(): void {
		$parent = phoenix_wp_bridge_gm_wcml_is_core_active() ? 'phoenix-wp-core' : 'woocommerce';
	...
	public function render_page(): void {
		...
		<div class="wrap">
			...
			<form method="post" action="options.php">
				<?php
				settings_fields( 'phoenix_wp_bridge_gm_wcml' );
				?>
